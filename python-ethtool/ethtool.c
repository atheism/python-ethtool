...
static PyObject *set_sg(PyObject *self __unused, PyObject *args)
{
    if (dev_set_int_value(ETHTOOL_SSG, args) < 0)
        return NULL;
...
static PyObject *set_ufo(PyObject *self __unused, PyObject *args)
{
    if (dev_set_int_value(ETHTOOL_SUFO, args) < 0)
        return NULL;
